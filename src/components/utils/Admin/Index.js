    ...
    return (
            ...
            <div className={ open ? 'navigation' : 'navigation navigation_active'}>
                <ul>
                    <li>
                        <a>
                            <Link to='/'>
                            <span className='icon'><GiSplitCross/></span>
                            <span className='title'>Ixuh_online</span>                                
                            </Link>
                        </a>
                    </li>
                    <li>
        ...
        <div className={ open ? 'admin_main' : 'admin_stretch'}>
            <div className='topbar'>
                ...
                {/* userImg */}
                <div className='user'>
                    <img src='https://images.unsplash.com/photo-1539887523427-bb750641ad29?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8YWZyaWNhbiUyMGJveXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60' alt='men whey dy alrigth' />
                </div>
            </div>
            ...
            <div className='details'>
                ...
                <div className='recentCustomers'>
                    ...
                    <table>
                        ...
                        <td width='60px'>
                            <div className='imgBx'>
                                <img src='https://images.unsplash.com/photo-1539887523427-bb750641ad29?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8YWZyaWNhbiUyMGJveXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60' />
                            </div>
                        </td>
                        <td>
                            <h4>{dev.name}<br/><span>Italy</span></h4>
                        </td>
                    </tr>                            
                        })}
